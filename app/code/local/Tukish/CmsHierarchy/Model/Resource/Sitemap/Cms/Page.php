 ...
 */
class Tukish_CmsHierarchy_Model_Resource_Sitemap_Cms_Page extends Mage_Sitemap_Model_Mysql4_Cms_Page
{
    protected function _construct()
    {
        Mage::getSingleton('core/resource')->setMappedTableName(
            'cms_page',
            Mage::getConfig()->getTablePrefix() . 'tukish_cms_page_tree'
        );
