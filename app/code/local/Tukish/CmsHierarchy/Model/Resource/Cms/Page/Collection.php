 ...
 */
class Tukish_CmsHierarchy_Model_Resource_Cms_Page_Collection extends Mage_Cms_Model_Mysql4_Page_Collection
{
    ...
    public function addChildrenFilter(Tukish_CmsHierarchy_Model_Cms_Page $page)
    {
    ...
    public function addAllChildrenFilter(Tukish_CmsHierarchy_Model_Cms_Page $page)
    {
