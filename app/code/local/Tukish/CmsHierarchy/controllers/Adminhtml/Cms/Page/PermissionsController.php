 ...
 */
class Tukish_CmsHierarchy_Adminhtml_Cms_Page_PermissionsController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        if (!Mage::getStoreConfigFlag('tukish_cmshierarchy/general/permissions_enabled')) {
            $this->_getSession()->addNotice(
                $this->__('Permissions are currently disabled. To enable permissions, ' .
                    'go to "System > Configuration > Tukish CmsHierarchy > General Settings".')
            );
        }
