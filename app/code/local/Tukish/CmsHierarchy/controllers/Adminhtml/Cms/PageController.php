...
class Tukish_CmsHierarchy_Adminhtml_Cms_PageController extends Mage_Adminhtml_Cms_PageController
{
    ...
    public function editAction()
    {
        ...
        if ($this->getRequest()->isXmlHttpRequest()) {
            $this->getLayout()->getBlock('root')->setTemplate('tukish/cmshierarchy/cms/page/ajax-edit.phtml');
        }
    ...
    public function treeAction()
    {
        ...
        $page = $this->_initPage();
        $block = $this->getLayout()->createBlock('tukish_cmshierarchy/adminhtml_cms_page_tree');
        $root = $block->getRoot();
    ...
    public function pagesJsonAction()
    {
        ...
        if ($pageId = (int) $this->getRequest()->getPost('id')) {
            ...
            $this->getResponse()->setBody(
                $this->getLayout()->createBlock('tukish_cmshierarchy/adminhtml_cms_page_tree')->getTreeJson($page)
            );
        }
    }
