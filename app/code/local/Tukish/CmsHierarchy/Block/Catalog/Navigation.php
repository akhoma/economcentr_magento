 ...
 */
class Tukish_CmsHierarchy_Block_Catalog_Navigation extends Mage_Catalog_Block_Navigation
{
     ...
     * @return string
     */
    public function renderCategoriesMenuHtmlTukish($level = 0, $isLast = true, $isFirst = true,
                                                   $outermostItemClass = '', $childrenWrapClass = '')
    {
