 ...
 */
class Tukish_CmsHierarchy_Block_Adminhtml_Cms_Page_Tree extends Mage_Adminhtml_Block_Template
{
    ...
    protected function _prepareLayout()
    {
        ...
        $switcher = $this->getLayout()->createBlock('adminhtml/store_switcher')
            ...
            ->setTemplate('tukish/cmshierarchy/cms/page/store/switcher.phtml');
    ...
    public function getRoot($parentNodePage = null, $recursionLevel = 3)
    {
        ...
        if (is_null($root)) {
            ...
            if (!$rootId) {
                $newRoot = Tukish_CmsHierarchy_Model_Cms_Page::createDefaultStoreRootPage($storeId);
