 ...
 */
class Tukish_CmsHierarchy_Block_Adminhtml_Cms_Page_Permissions_Tree extends Mage_Adminhtml_Block_Template
{
    ...
    public function getRoot()
    {
        if (null === $this->_root) {
            ...
            if (!$this->_root->getId()) {
                $this->_root = Tukish_CmsHierarchy_Model_Cms_Page::createDefaultStoreRootPage($storeId);
            }
        }
    ...
    protected function _getNodeJson(Tukish_CmsHierarchy_Model_Cms_Page $page)
    {
        $item = array();
