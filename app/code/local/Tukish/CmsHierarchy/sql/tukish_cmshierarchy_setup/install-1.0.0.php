...
/* @var $installer Tukish_CmsHierarchy_Model_Resource_Setup */
$installer = $this;
...
$tablePageTree = $installer->getTable('tukish_cms_page_tree');
$tablePermission = $installer->getTable('tukish_cms_page_permission');
...
foreach ($stores as $store) {
    ...
    $home = Tukish_CmsHierarchy_Model_Cms_Page::createDefaultStoreRootPage($storeId);
    $homeId = $home->getId();
...
$tablePageTreeStore = $installer->getTable('tukish_cms_page_tree_store');
